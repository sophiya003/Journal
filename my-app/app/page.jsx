    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <div className="relative">
          ...
          <div className="bg-white rounded-2xl  p-4 max-full mx-auto">
            ...
            <div className="space-y-4 p-4">
              ...
              <Skeleton className="h-4 bg-pinke-100 rounded w-full" />
              <Skeleton className="h-4 bg-pink-100 rounded w-2/3" />
            </div>
          </div>
        </div>
        <div className="flex justify-center gap-4">
          ...
          <Link href="#features">
            <Button
              variant="outline"
              className="px-8 py-6 rounded-full border-pink-600 text-pink-600 hover:bg-pink-100"
            >
              Learn More
            </Button>
          </Link>
        ...
        {features.map((feature, index) => (
          <Card key={index} className="shadow-lg">
            <CardContent className="p-6">
              ...
              <h3 className="font-semibold text-xl text-pink-900 mb-2">
                {feature.title}
              </h3>
      ...
      <div className="space-y-24 mt-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:flex-row-reverse">
          ...
          <div className="space-y-4 bg-white rounded-2xl shadow-xl p-6 border border-pink-100 md:order-1">
            {/* Analytics Preview */}
            <div className="h-40 bg-gradient-to-t from-pink-100 to-orange-50 rounded-lg"></div>
        ...
        <Accordion type="single" collapsible className="w-full mx-auto">
          {faqs.map((faq, index) => (
            <AccordionItem key={index} value={`item-${index}`}>
              <AccordionTrigger className="text-pink-900 text-lg">
                {faq.q}
              </AccordionTrigger>
